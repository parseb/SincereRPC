...
contract HelloWorldDeployer is Script, Utils {
    ...
    function run() external {
        ...
        _deployHelloWorldContracts(
            delegationManager, avsDirectory, erc20MockStrategy, helloWorldCommunityMultisig, helloWorldPauser
        );
        vm.stopBroadcast();
    }
    ...
    function _deployHelloWorldContracts(
        ...
        {
            StrategyParams[] memory quorumsStrategyParams = new StrategyParams[](
                    numStrategies
            );
        ...
        vm.serializeAddress(deployed_addresses, "HelloWorldServiceManagerProxy", address(helloWorldServiceManagerProxy));
        vm.serializeAddress(
            deployed_addresses,
